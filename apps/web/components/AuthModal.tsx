...
export default function AuthModal({
  ...
  async function handleLoginOtpVerify(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
        ...
        >
          ...
          {isSuccess ? (
            ...
            <div>
              ...
              {showLoginOtp && mode === 'login' ? (
                <form
                  onSubmit={handleLoginOtpVerify}
                  className="space-y-5"
                >
                  <div className="text-center py-4">
                    <div className="mx-auto mb-5 w-16 h-16 rounded-2xl bg-[#00FF66]/10 border border-[#00FF66]/30 flex items-center justify-center">
                    ...
                    <p className="mt-1 text-xs font-bold text-[#00FF66] break-all">
                      {email}
                    </p>
                  </div>

                  <div>
                    <label className="block text-[10px] font-extrabold text-gray-400 uppercase mb-2">
                      ENTER OTP
                    </label>
                    ...
                    <input
                      ...
                      placeholder="000000"
                      disabled={loading}
                      className="w-full bg-black/40 border border-white/10 rounded-2xl px-4 py-4 text-center text-white text-2xl font-black tracking-[0.5em] outline-none focus:border-[#00FF66] transition-colors disabled:opacity-50"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-[#00FF66] to-emerald-400 text-black font-black text-xs uppercase tracking-widest rounded-2xl hover:brightness-110 transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#00FF66]/30 disabled:opacity-50 italic"
                  >
